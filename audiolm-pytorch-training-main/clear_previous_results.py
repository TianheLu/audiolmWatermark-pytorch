# assuming running from audiolmWatermark-pytorch-training and results in audiolmWatermark-pytorch-results
...
results_folder = "../audiolmWatermark-pytorch-results"
