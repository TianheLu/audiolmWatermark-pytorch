...
if __name__ == "__main__":
    dataset = CocochoralesCustomDataset(folder='/fsx/itsleonwu/audiolmWatermark-pytorch-datasets/cocochorales_main_dataset_v1/1', target_sample_hz=16000, max_length_samples=16000 * 30)
