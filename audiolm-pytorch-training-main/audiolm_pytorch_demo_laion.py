...
if args.run_mode == "openslr":
    dataset = None
    dataset_folder = "/fsx/itsleonwu/audiolmWatermark-pytorch-datasets/LibriSpeech-dev-clean/dev-clean"
    ...
    dataset = None
    dataset_folder = "/fsx/itsleonwu/audiolmWatermark-pytorch-datasets/many_identical_copies_of_cocochorales_single_sample_resampled_24kHz_trimmed_first_second"
    ...
    dataset = None
    dataset_folder = "/fsx/itsleonwu/audiolmWatermark-pytorch-datasets/cocochorales_single_sample_unprocessed"
    ...
    folder = "/fsx/itsleonwu/audiolmWatermark-pytorch-datasets/cocochorales_main_dataset_v1"
    ...
    dataset_folder = "/fsx/itsleonwu/audiolmWatermark-pytorch-datasets/test_long_sample"
    num_train_steps = 100
    save_every = 50
...
prefix = "/fsx/itsleonwu/audiolmWatermark-pytorch-results"
