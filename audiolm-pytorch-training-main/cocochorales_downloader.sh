...
for i in $(seq 1 1 60); do
  ...
  # aws s3 cp /fsx/itsleonwu/audiolmWatermark-pytorch-datasets/cocochorales_main_dataset_v1_zipped/"$i".tar.bz2 s3://s-laion/itsleonwu-laion/cocochorales_main_dataset_v1_zipped --profile laion-stability-my-s3-bucket
