...
class SoundStreamTrainer(nn.Module):
    ...
    def train_step(self):
        ...
        losses_str = (f"{steps}: soundstream total loss: {logs['loss']:.5f}, " +
                      f" reconstruct loss: {logs['recon_loss']:.5f}, " +
                      f" reconstruct loss weight: {self.soundstream.recon_loss_weight}, " +
                      f" multi_spectral reconstruct loss: {logs['multi_spectral_recon_loss']:.5f}, " +
                      f" multi_spectral reconstruct loss weight: {self.soundstream.multi_spectral_recon_loss_weight}, " +
                      f" adversarial loss: {logs['adversarial_loss']:.5f}, " +
                      f" adversarial loss weight: {self.soundstream.adversarial_loss_weight}, " +
                      f" feature loss: {logs['feature_loss']:.5f}, " +
                      f" feature loss weight: {self.soundstream.feature_loss_weight}, " +
